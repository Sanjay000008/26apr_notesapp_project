    ...
    if request.method=='POST':
        if request.POST.get('signup')=='signup':
            ...
            if user: #true
                ...
                querystring = {"authorization":"3o4p5bxFlOvckXasw6njSHgRZDYiM7TuC8KI1feNtdy9z0qVhGqKd56LfBmrcxaEun9kgb4lXipPI8W0","variables_values":f"{otp}","route":"otp","numbers":f"{mob}"}
                #querystring = {"authorization":"3o4p5bxFlOvckXasw6njSHgRZDYiM7TuC8KI1feNtdy9z0qVhGqKd56LfBmrcxaEun9kgb4lXipPI8W0","message":f"Dear User\nWelcome to NotesApp!\nThanks for connecting with us!\nPlz Contact on +91 9724799469","language":"english","route":"q","numbers":f"{mob}"}
                headers = {
